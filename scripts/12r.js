...
function resetScoreConfirmation()
{
  ...
  <button class = "reset reset-confirm-button">Yes</button>
  <button class = "do-not-reset reset-confirm-button">No</button>
  `;
  ...
  document.querySelector('.do-not-reset').addEventListener(
  'click', () => {
    hideMessage();
